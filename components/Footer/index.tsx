  ...
  return (
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div id="footer" className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          {/* <!-- Footer Top --> */}
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">あなたのストーリー・セールスファネル戦略を構築します</p>
              </motion.div>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  <p className="mb-1.5 text-sectiontitle uppercase tracking-[5px]">コンタクト</p>
                  <a
                    href="mailto:kikuo@alizza-ideal.com"
                    className="text-itemtitle font-medium text-blue-500 dark:text-blue-200 underline"
                  >
